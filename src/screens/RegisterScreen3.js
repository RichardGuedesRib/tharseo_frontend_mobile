  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        <Text style={styles.formLabel}>Configure sua conta</Text>
        <Text style={styles.verificationText}>
          Sua conta foi criada com sucesso! Configure-a agora ou faça isso mais
          tarde.
        </Text>

        <View style={styles.inputContainer}>
          <TextInput
            placeholder="Digite aqui a APIKEY..."
        ...
        <View style={styles.inputContainer}>
          <TextInput
            placeholder="Digite aqui a SECRETKEY..."
            placeholderTextColor="#b0b0b0"
            style={styles.input}
            keyboardType="number-pad"
            maxLength={6}
        ...
        <TouchableOpacity>
          <Text style={styles.help} onPress={() => navigation.navigate('Login')}>Pular Etapa</Text>
        </TouchableOpacity>
